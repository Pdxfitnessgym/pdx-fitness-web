...
export default function TrainerChatPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    ...
    supabase.auth.getUser().then(async ({ data: { user } }) => {
      ...
      const channel = supabase
        .channel(`trainer-chat:${conversationId}`)
        .on("postgres_changes", {
          event: "INSERT",
          schema: "public",
          table: "messages",
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100dvh", background: "#F4F7FA" }}>
      ...
      <div style={{ background: "#fff", borderBottom: "1px solid #E2EAF0", padding: "12px 16px", flexShrink: 0 }}>
        <div style={{ maxWidth: 640, margin: "0 auto", display: "flex", alignItems: "center", gap: 12 }}>
          <Link href="/trainer/messages" style={{ fontSize: 20, textDecoration: "none", color: "#6B7A8D", lineHeight: 1 }}>←</Link>
